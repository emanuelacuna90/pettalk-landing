  ...
  return (
    <div className="page">
      <header className="header">
        <div className="logo">
          {/* Reemplaza src por tu logo cuando lo tengas */}
          <div className="logo-img">Logo</div>
          <div>
            <div className="logo-title">PetTalk</div>
            <div className="logo-subtitle">
              Traduce ladridos y maullidos en tiempo real.
            </div>
          </div>
        </div>
        <nav className="nav">
          ...
          <a href="#ia">IA</a>
          <a href="#comercio">Comercio Int.</a>
        ...
        <section className="sections-grid">
          ...
          <article className="section-card" id="comercio">
            ...
            <ul className="section-list">
              ...
              <li>
                <strong>Regulaciones y certificaciones:</strong> cumplimiento de normas para dispositivos electrónicos y
                productos para animales.
              </li>
              <li>
                <strong>Estrategias de entrada:</strong> alianzas con distribuidores locales y campañas adaptadas a cada
                mercado.
              </li>
              <li>
      ...
      <footer className="footer">
        <span>
          © {new Date().getFullYear()} PetTalk. Todos los derechos reservados.
        </span>
        <span>
